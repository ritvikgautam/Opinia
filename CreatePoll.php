			...
			<div class="head-contact text-center">
				<div style="background: ; padding: 15px; text-align: center;">
					...
					<form method="POST" action="savequestion.php">
						<div class="content">
							<input type="text" class="search" id="searchid" placeholder="Search for topic" name="topic" autocomplete="off" style="width:75%"/>
						...
						<input type="button" value="Add Option" onClick="addRow('dataTable')" style="float:left"/> 
